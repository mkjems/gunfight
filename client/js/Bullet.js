...
GF.Bullet.findCollision = function (fromX, fromY, toX, toY) {
    ...
    lines.forEach(function (line) {
        var collision = GF.Bullet.getSegmentIntersection(
            fromX,
            fromY,
            toX,
            toY,
        ...
        collision.normal = GF.Bullet.getReflectionNormal(
            line,
            toX - fromX,
            toY - fromY
        );
...
GF.Bullet.getCollisionLines = function () {
    return [
        ...
        {
            x1: 0,
            y1: GF.Config.canvas.height,
            x2: GF.Config.canvas.width,
            y2: GF.Config.canvas.height
        }
