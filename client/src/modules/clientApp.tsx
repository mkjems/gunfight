...
import {
    GameHudComponent,
    type GameHudProps
} from './gameHudComponentScreen.js';
import {
    HighScoresScreen,
    type HighScoresProps
} from './highScoresComponentScreen.js';
import { LobbyMain, type LobbyComponentProps } from './lobbyComponentScreen.js';
import {
    NameEditorComponent,
    type NameEditorProps
} from './nameEditorComponentScreen.js';
import { Screen } from './clientScreens.js';
import {
    TouchGameplayControls,
    type TouchGameplayControlsProps
} from './touchGameplayControlsComponentScreen.js';
import {
    TouchLobbyControls,
    type TouchLobbyControlsProps
} from './touchLobbyControlsComponentScreen.js';
