...
| Straightness meter        | Visual indicator under a gameplay player showing the straightness value the next shot will use. In code, prefer `straightnessMeter`.          | Planned in `TODO8.md`                                           |
